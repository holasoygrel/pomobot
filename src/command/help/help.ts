...
let helpEmbed = new MessageEmbed()
    ...
    .addFields(
        ...
        { name: '% pomodoro [numero] descanso [numero]', value: 'Inicia un Pomodoro con la duración indicada'},
        { name: '% grupo [numero] ', value: 'Inicia un Pomodoro grupal con una duración indicada'},
        { name: '% grupo [numero] descanso [numero]', value: 'Inicia un Pomodoro grupal con un descanso'},
